...
export function TarjetaMetrica({ titulo, valor, icono: Icono, colorIcono, descripcion }: TarjetaMetricaProps) {
  return (
    <Card className="relative overflow-hidden shadow-sm dark:shadow-none border-l-[3px] border-l-primary hover:-translate-y-[2px] transition-all duration-300 animate-fade-in-up group">
